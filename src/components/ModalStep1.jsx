...
const ModalStep1 = ({ onSelect, nextStep, progress, step, selectedOptions }) => {
  const options = ['Myself', 'My partner', 'Other adults','Teens(13+)','Kids','Pets'];
  ...
  return (
    <div className="fixed inset-0  bg-opacity-75 flex items-center justify-center p-4">
      <div className="bg-primary rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#BF40BF]">Who do you spend money on?</h2>
        {options.map(option => (
          <button
            key={option}
