...
const ModalStep3 = ({ onSelect, nextStep, progress, step, selectedOptions }) => {
  const options = ['Credit Card','Student Loans','Auto Loans','Personal Loans','Medical Debt'];
  ...
  return (
    <div className="fixed inset-0  bg-opacity-75 flex items-center justify-center p-4">
      <div className="bg-primary rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#BF40BF]">Do you currently have any debt?</h2>
        {options.map(option => (
          <button
            key={option}
