...
const ModalStep2 = ({ onSelect, nextStep, progress, step, selectedOptions }) => {
  const options = ['I rent', 'I own', 'Other'];
  ...
  return (
    <div className="fixed inset-0  bg-opacity-75 flex items-center justify-center p-4">
      <div className="bg-primary rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#BF40BF]">Tell us about your home</h2>
        {options.map(option => (
          <button
            key={option}
